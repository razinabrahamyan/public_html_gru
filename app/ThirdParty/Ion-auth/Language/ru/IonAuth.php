...
return [
	...
	'account_delete_successful'    			=> 'Учетная запись успешно удалена',
	'account_delete_unsuccessful'    		=> 'Невозможно удалить учетную запись',
	...
	'email_forgotten_password_subject'    => 'Ссылка для восстановления пароля',
	'emailForgotPassword_heading'    => 'Сброс пароля для пользователя %s',
	'emailForgotPassword_subheading' => 'Нажмите на ссылку для восстановления: ',
