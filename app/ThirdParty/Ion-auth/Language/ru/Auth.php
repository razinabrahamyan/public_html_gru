...
return [
	...
	'delete_submit_btn'               	  => 'Удалить',
	'delete_heading'                      => 'Удалить пользователя',
	'delete_subheading'                   => 'Вы уверены, что хотите удалить пользователя \'%s\'',
	...
	'reset_password_subheading'              => 'Пожалуйста введите новый пароль',
	'reset_password_new_password_label'                    => 'Новый пароль (минимум 8 символов):',
	'reset_password_new_password_confirm_label'            => 'Повторить пароль',
	...
	'emailForgotPassword_subheading' => 'Пожалуста по ссылке для сброса пароля: ',
